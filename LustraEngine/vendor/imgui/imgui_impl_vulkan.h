...
#pragma once
    ...
    // (When using Volk from directory outside your include directories list you can specify full path to the volk.h
    // header,
...
struct ImGui_ImplVulkan_InitInfo
{
	...
	uint32_t DescriptorPoolSize; // Optional: set to create internal ImageView descriptor pool automatically instead of
...
ImGui_ImplVulkan_AddTexture(VkSampler sampler, VkImageView image_view, VkImageLayout image_layout); // Ignore VkSampler
	#endif
